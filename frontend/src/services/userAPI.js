...
export const getAssignedExperiments = (userId) =>
  api.get(`/experiments/assigned/${userId}`);
...
export const updateExperiment = (experimentId, payload) =>
  api.patch(`/experiments/${experimentId}`, payload);
...
export const getExperimentFiles = (experimentId) =>
  api.get(`/experiments/${experimentId}/files`);

// Delete a file (admin only in backend logic).
// Backend route: DELETE /api/experiments/:id/files/:fileId
export const deleteExperimentFile = (experimentId, fileId) =>
  api.delete(`/experiments/${experimentId}/files/${fileId}`);
